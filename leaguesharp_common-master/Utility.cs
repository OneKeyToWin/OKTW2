namespace LeagueSharp.Common
{
    ...
    public static class Utility
    {
            ...
            Vector3 from = new Vector3())
        {
            ...
            if (@base != null && 
                @base.BaseSkinName == "SennaSoul" && 
                HeroManager.Player.ChampionName != "Senna")
            {
                return false;
            }
        ...
        public static class HpBarDamageIndicator
        {
            ...
            public static Color FillColor = Color.FromArgb(125, Color.Lime);
            ...
            private static void Drawing_OnDraw(EventArgs args)
            {
                    ...
                    HeroManager.Enemies.FindAll(h => h.IsValid && h.IsHPBarRendered))
                {
                    ...
                    {
                        Text.X = (int)barPos.X + XOffset - 22;
                        Text.Y = (int)barPos.Y + YOffset - 18;
                    ...
                    if (Fill)
                    {
                        ...
                        var differenceInHp = xPosCurrentHp - xPos;
                        var pos1 = barPos.X + (Drawing.Height >= 1440 ? 19 : 9) + (Width * percentHealthAfterDamage);

                        for (var i = 0; i < differenceInHp; i++)
                        {
                            Drawing.DrawLine(pos1 + i, barPos.Y + YOffset, pos1 + i, barPos.Y + YOffset + Height, 1, FillColor);
                        }
                    }
                }
            }
