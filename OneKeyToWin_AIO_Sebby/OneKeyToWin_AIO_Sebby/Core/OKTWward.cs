...
namespace OneKeyToWin_AIO_Sebby.Core
{
    ...
    class OKTWward : Program
    {
        ...
        public void LoadOKTW()
        {
            ...
            MainMenu.SubMenu("AutoWard OKTW©").AddItem(new MenuItem("AutoWardBlue", "Auto Blue Trinket").SetValue(true));
            MainMenu.SubMenu("AutoWard OKTW©").AddItem(new MenuItem("AutoWardCombo", "Only combo mode").SetValue(true));
            MainMenu.SubMenu("AutoWard OKTW©").AddItem(new MenuItem("AutoWardPink", "Auto VisionWard, OracleLens").SetValue(true));
