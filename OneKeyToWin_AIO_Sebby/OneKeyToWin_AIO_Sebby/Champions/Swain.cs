    ...
    class Swain : Base
    {
        ...
        public Swain()
        {
            ...
            foreach (var enemy in HeroManager.Enemies)
                Config.SubMenu(Player.ChampionName).SubMenu("Q Config").SubMenu("Use on:")
            ...
            Config.SubMenu(Player.ChampionName).SubMenu("W Config").AddItem(
        ...
        {
            if (!W.IsReady() || sender.IsMinion || !sender.IsEnemy || !Config.Item("Wspell", true).GetValue<bool>() ||
        ...
        private void LogicQ()
        {
            ...
            if (t.IsValidTarget())
            {
                ...
                if (Program.Combo && Player.Mana > RMANA + EMANA)
                    Program.CastSpell(Q, t);
                else if (Program.Harass && Config.Item("harassQ", true).GetValue<bool>() &&
                         Player.Mana > RMANA + EMANA + WMANA + EMANA &&
                         Config.Item("Harass" + t.ChampionName).GetValue<bool>())
                    Program.CastSpell(Q, t);
        ...
        private void LogicE()
        {
            ...
            if (t.IsValidTarget())
            {
                ...
                if (Program.Combo && Player.Mana > RMANA + EMANA)
                    Program.CastSpell(Q, t);
                else if (Program.Harass && Config.Item("harassE", true).GetValue<bool>() &&
                         Player.Mana > RMANA + EMANA + WMANA + EMANA &&
                         Config.Item("Harass" + t.ChampionName).GetValue<bool>())
                    Program.CastSpell(Q, t);
            }
