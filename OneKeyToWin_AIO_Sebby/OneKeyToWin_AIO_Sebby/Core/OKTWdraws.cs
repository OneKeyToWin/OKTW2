...
//            {
//                //foreach (var hero in TrackerCore.ChampionInfoList.Where(x => x.Hero.IsEnemy))
//                //{
...
//            {
//                var jungler = TrackerCore.heroes_info.FirstOrDefault(x => x.Value.org.IsEnemy && x.Value.is_jungler).Value.org;
...
//            foreach (var hero in TrackerCore.ChampionInfoList.Where(x => !x.Hero.IsDead))
//            {
